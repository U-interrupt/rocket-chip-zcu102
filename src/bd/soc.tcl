...
proc create_root_design { parentCell } {
  ...
  # Create instance: vio_resetn, and set properties
  set vio_resetn [ create_bd_cell -type ip -vlnv xilinx.com:ip:vio:3.0 vio_resetn ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_ps_M00_AXI [get_bd_intf_pins axi_interconnect_ps/M00_AXI] [get_bd_intf_pins hier_uart/S00_AXI1_ps]
  connect_bd_intf_net -intf_net axi_interconnect_ps_M01_AXI [get_bd_intf_pins axi_interconnect_ps/M01_AXI] [get_bd_intf_pins axi_intr_ps2pl/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_ps_M02_AXI [get_bd_intf_pins axi_interconnect_ps/M02_AXI] [get_bd_intf_pins axi_jtag/s_axi]
  ...
  connect_bd_intf_net -intf_net rocketchip_wrapper_M_AXI [get_bd_intf_pins rocketchip_wrapper/M_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  ...
  connect_bd_net -net constant_0_dout [get_bd_pins constant_0/dout] [get_bd_pins soc_clk_wiz/reset]
  ...
  connect_bd_net -net interconnect_aresetn_1 [get_bd_pins axi_interconnect_ps/ARESETN] [get_bd_pins axi_interconnect_rocket/ARESETN] [get_bd_pins hier_uart/interconnect_aresetn] [get_bd_pins proc_sys_reset/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_mb_reset [get_bd_pins proc_sys_reset/mb_reset] [get_bd_pins rocketchip_wrapper/reset]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_led/s_axi_aresetn] [get_bd_pins axi_interconnect_ps/M00_ARESETN] [get_bd_pins axi_interconnect_ps/M01_ARESETN] [get_bd_pins axi_interconnect_ps/M02_ARESETN] [get_bd_pins axi_interconnect_ps/S00_ARESETN] [get_bd_pins axi_interconnect_rocket/M00_ARESETN] [get_bd_pins axi_interconnect_rocket/M01_ARESETN] [get_bd_pins axi_interconnect_rocket/S00_ARESETN] [get_bd_pins axi_intr_ps2pl/s_axi_aresetn] [get_bd_pins axi_jtag/s_axi_aresetn] [get_bd_pins hier_uart/uart_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn]
  ...
  connect_bd_net -net soc_clk_wiz_clk_100M [get_bd_pins axi_gpio_led/s_axi_aclk] [get_bd_pins axi_interconnect_ps/ACLK] [get_bd_pins axi_interconnect_ps/M00_ACLK] [get_bd_pins axi_interconnect_ps/M01_ACLK] [get_bd_pins axi_interconnect_ps/M02_ACLK] [get_bd_pins axi_interconnect_ps/S00_ACLK] [get_bd_pins axi_interconnect_rocket/ACLK] [get_bd_pins axi_interconnect_rocket/M00_ACLK] [get_bd_pins axi_interconnect_rocket/M01_ACLK] [get_bd_pins axi_intr_ps2pl/s_axi_aclk] [get_bd_pins axi_jtag/s_axi_aclk] [get_bd_pins hier_uart/uart_aclk] [get_bd_pins soc_clk_wiz/clk_100M] [get_bd_pins vio_resetn/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
  connect_bd_net -net soc_clk_wiz_clk_50M [get_bd_pins axi_interconnect_rocket/S00_ACLK] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins rocketchip_wrapper/clk] [get_bd_pins soc_clk_wiz/clk_50M] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net soc_clk_wiz_locked [get_bd_pins proc_sys_reset/dcm_locked] [get_bd_pins soc_clk_wiz/locked]
  connect_bd_net -net vio_resetn_probe_out0 [get_bd_pins proc_sys_reset/aux_reset_in] [get_bd_pins vio_resetn/probe_out0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins soc_clk_wiz/clk_in1] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0x000100000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces rocketchip_wrapper/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  ...
  assign_bd_address -offset 0x80011000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_jtag/s_axi/reg0] -force
